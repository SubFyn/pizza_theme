              ...
              Column(
                children: [
                  ...
                  Container( alignment:Alignment.centerLeft, child: const Text('Размер:',
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold), ), padding: const EdgeInsets.fromLTRB(0, 0, 0, 5),),
                  ...
                  Container( alignment:Alignment.centerLeft, child: const Text('Соус:',
                    style: TextStyle(fontSize: 18, color: Color(0xFF263238), fontWeight: FontWeight.bold),),),
                  RadioListTile<Sauce>(
                    ...
                    child: Card(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Text('Дополнительный сыр', style: TextStyle(fontSize: 16, color: Color(0xFF263238)),),
